...
from input_data import load_network_data
import inspect
...
def get_placeholder(adj):
    placeholders = {
        ...
        'real_distribution': tf.compat.v1.placeholder(dtype=tf.float32, shape=[adj.shape[0], FLAGS.hidden2], name='real_distribution')
    }
...
def format_data(data_name):
    ...
    adj, features = load_network_data(data_name)
    ...
    #names = ['adj', 'num_features', 'num_nodes', 'features_nonzero', 'pos_weight', 'norm', 'adj_norm', 'adj_label', 'features', 'true_labels', 'train_edges', 'val_edges', 'val_edges_false', 'test_edges', 'test_edges_false', 'adj_orig']
    ...
    items = [adj, num_features, num_nodes, features_nonzero, pos_weight, norm, adj_norm, adj_label, features, train_edges, test_edges, test_edges_false, adj_orig]
    names = ['adj', 'num_features', 'num_nodes', 'features_nonzero', 'pos_weight', 'norm', 'adj_norm', 'adj_label', 'features', 'train_edges', 'test_edges', 'test_edges_false', 'adj_orig']
