...
def mask_test_edges(adj, adj_name='xx', test_percent = 10.):
    ...
    test_edge_idx = edges_positive_idx[:num_test]
    ...
    if adj_name=='karate':
        train_edges = edges_positive
    else:
        train_edges = np.delete(edges_positive, test_edge_idx, axis = 0) # positive train edges
